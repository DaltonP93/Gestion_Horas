...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/mis-documentos',icon: FileText,        i18nKey: 'nav.my_documents',  desc: 'Recibos, contratos y certificados publicados por RR.HH.', portal: true, roles: ['employee'], module: 'mis_documentos', color: 'bg-fuchsia-500' },
    ],
  },
  {
    ...
    items: [
      ...
      { href: '/aprobacion-reportes', icon: FileSignature, i18nKey: 'nav.report_approvals', desc: 'Enviar, aprobar y firmar el reporte mensual.', roles: ['admin','gth','hr','coordinator','manager','gestor'], module: 'aprobaciones', color: 'bg-blue-600' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/configuracion/laboral', icon: SlidersHorizontal, i18nKey: 'nav.workday_defaults', desc: 'Configuración de jornada histórica y jerárquica.', roles: ['admin','gth','hr'], module: 'configuracion', color: 'bg-indigo-600' },
